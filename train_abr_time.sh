...
do
    ...
    --num_mini_batch 1 --episode_length 100 --num_env_steps 70000 --ppo_epoch 15 \
    --gain 0.01 --lr 1.5e-4 --critic_lr 1.5e-4 --hidden_size 512 --layer_N 2 --entropy_coef 0.015 --use_wandb
